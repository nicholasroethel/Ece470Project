...
GA_args.add_argument("--mutate_chance", type=float, default=.35, help="Length of key to use")
GA_args.add_argument("--survival_rate", type=float, default=.5, help="How many parents are selected to move to the next round")
