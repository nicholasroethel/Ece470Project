...
GA_args.add_argument("--max_gen", type=int, default=100, help="Maximum number of generations")
GA_args.add_argument("--mutate_chance", type=float, default=.05, help="Length of key to use")
GA_args.add_argument("--survival_rate", type=float, default=.1, help="How many parents are selected to move to the next round")
